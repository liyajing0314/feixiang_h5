<template>
  <div class="container">
    <div class="location-head">
      <span>万达影城-湖北-武汉-春树里店超级影城影城影城影城</span>
    </div>
    <!-- :style="{height:contentHeight+'px'}" -->
    <div style="position: relative;width:100%;height:100%;" >
      <img ref="bacImg" :src="imgSrc" style="height:100%;" />
      ...
      getData() {
        ...
        let loadproject = {
          ...
          "result": {
            ...
            "beaconNum": "226",
            "scale": 3.0,
            "TodayWorkTime": "5197.10",
            "cardNum": "25",
            "personnumber": 22,
            "roomNum": "102",
            "kaoqinID": "12345678934",
            "TodayPersonNum": "24",
            "errorkaoqin": "0",
            "name": "德必WE文创园(天坛)",
        ...
        this.$nextTick(() => {
          ...
          this.img.onload = function() {
            ...
            for (let i = 0; i < this_.locationList.length; i++) {
              this_.initArr[i] = {};
              this_.initArr[i].x = (this_.locationList[i].longitude) / this_.ratioImgCanvas;
              this_.initArr[i].y = (this_.locationList[i].latitude) / this_.ratioImgCanvas1;
            }
